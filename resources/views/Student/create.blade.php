...
<body class="bg-[#F7FFF7] min-h-screen">
  ...
  <div class="flex justify-center items-center min-h-screen pt-16">
    ...
    <h1 class="text-2xl font-bold text-[#2C3E50] mb-6 text-center">Create Student</h1>
    ...
    <form action="{{ route('student.store') }}" method="POST" class="space-y-5">
      ...
      <div>
        ...
        <input type="text" id="name" name="name" value="{{ old('name') }}" placeholder="Enter student name" 
