...
<div id="editModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
  <div class="bg-white rounded-2xl shadow-2xl w-full max-w-3xl mx-4 p-6">
    ...
    <form id="editForm" method="POST" class="space-y-5">
      ...
      <!-- Supplier Name -->
      <div>
        <label for="edit_name" class="block text-sm font-medium text-gray-700 mb-1">Supplier Name</label>
        <input type="text" id="edit_name" name="name" placeholder="Enter supplier name"
      ...
      <div>
        ...
        <input type="text" id="edit_location" name="location" placeholder="Enter location"
      ...
      <div>
        ...
        <textarea id="edit_notes" name="notes" rows="3" placeholder="Enter additional notes"
          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 focus:outline-none @error('notes') border-red-500 @enderror"></textarea>
        @error('notes')
          <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
        @enderror
      </div>
